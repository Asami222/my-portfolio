...
const data = [
	{
		title: 'Asami',
		text: dedent`ユーザビリティやアクセシビリティの高いWebアプリケーションを目指して制作しています。
		デザインから実装までを行うことで、より深い知識と理解を得ることができると考えています。今後はサーバーサイドやDBの理解を深めていくことを目標としています。`,
		image: [
			{alt: 'Asami', src: '/about/me.png',}
		]
	},
	{
		title: 'Skill',
